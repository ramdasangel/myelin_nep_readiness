...
# Teacher question counts per FP section
FP_Q_COUNTS = {"FP1": 4, "FP2": 4, "FP3": 5, "FP4": 5, "FP5": 4}
...
def load_data():
    # Per user: {uid: {bc, lang, fp_opts: {fp: [opts]}}}
    users = {}
    ...
    for fname, lang in FILES:
        ...
        with open(fpath) as f:
            for row in csv.DictReader(f):
                ...
                if uid not in users:
                    users[uid] = {"bc": bc, "lang": lang, "fp_opts": defaultdict(list)}
...
<th style="text-align:center" onclick="sortTbl(2,'n','profileTable')">Users</th>
<th style="text-align:center">Lang</th>
%(fp_th_profile)s
<th style="text-align:center" onclick="sortTbl(9,'s','profileTable')">Highest</th>
</tr></thead>
...
<thead><tr>
<th>Branch</th><th>Name</th><th style="text-align:center">Users</th><th style="text-align:center">Total</th>
%(fp_th_raw)s
</tr></thead>
